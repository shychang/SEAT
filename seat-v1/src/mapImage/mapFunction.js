export function MapFunction(prop){

    const seatStatus = prop.taken

    return(
     <svg  height="560px" viewBox="0 0 960 560" enable-background="new 0 0 960 560"> 
   <g id="Room_Border_1_">
  ...
  <g id="Tables">
    ...
    <g id="Individual_Tables">
        ...
        <rect id="IT-3" x="195" y="61" transform="matrix(0.9998 -0.0195 0.0195 0.9998 -1.6176 4.2913)" fill="#BFCFFF" stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" width="48" height="48"/>
  ...
  <g id="Seats">
    <path id="S66" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" d="M626.375,457.052
    ...
    <path id="S65" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" d="M653.023,489.268
    ...
    <path id="S62" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" d="M687.769,406.398
    ...
    <path id="S60" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" d="M437.375,460.052
    ...
    <path id="S55" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" d="M452.899,414.32
      c-5.095-2.762-6.995-9.131-4.237-14.231c2.762-5.1,9.137-6.997,14.232-4.233c5.105,2.761,6.998,9.131,4.236,14.232
      C464.369,415.184,458,417.08,452.899,414.32z"/>
    <path id="S54" fill={seatStatus} stroke="#FFE9EA" stroke-width="4" stroke-miterlimit="10" d="M234.375,458.052
      c-4.941,3.034-11.407,1.494-14.443-3.445c-3.038-4.942-1.494-11.409,3.449-14.442c4.941-3.039,11.405-1.493,14.442,3.448
    ...
    <circle id="S43" fill="#FFF" stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" cx="444.253" cy="331.707" r="10.5"/>
    <circle id="S42" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" cx="414.253" cy="331.707" r="10.5"/>
    <circle id="S41" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" cx="386.253" cy="331.707" r="10.5"/>
    <circle id="S40" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" cx="359.253" cy="331.707" r="10.5"/>
    ...
    <circle id="S32" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" cx="414.253" cy="280.707" r="10.5"/>
    <circle id="S31" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" cx="386.253" cy="280.707" r="10.5"/>
    <circle id="S30" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" cx="359.253" cy="280.707" r="10.5"/>
    <circle id="S29" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" cx="331.253" cy="280.707" r="10.5"/>
    <circle id="S28" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" cx="629.253" cy="249.707" r="10.5"/>
    ...
    <circle id="S20" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" cx="359.253" cy="249.707" r="10.5"/>
    ...
    <circle id="S7" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" cx="789.253" cy="120.707" r="10.5"/>
    ...
    <circle id="S3" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" cx="219.254" cy="120.707" r="10.499"/>
    <circle id="S2" fill="#C1272D" stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" cx="171.254" cy="120.707" r="10.499"/>
    <circle id="S1" fill={seatStatus} stroke="#FFE9EA" stroke-width="2" stroke-miterlimit="10" cx="123.254" cy="120.707" r="10.499"/>
  </g>
  </svg>)
